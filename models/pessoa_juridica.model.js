...
function pessoaJuridicaModel(sequelize, DataType) {
  var constructor = {
    cnpj: { type: DataType.INTEGER(16), allowNull: false, primaryKey: true, unique: true, validate: { is: /\d{16}/ } },
    ...
    data_fundacao: { type: DataType.DATE, allowNull: false }
  };
  var configs = { tableName: 'pessoa_juridica' };
  var PessoaJuridica = sequelize.define(MODEL_NAME, constructor, configs);

  PessoaJuridica.hasOne(Pessoa, { foreignKey: 'pessoa_juridica' });
