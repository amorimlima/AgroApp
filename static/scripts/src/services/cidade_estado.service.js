class CidadeEstadoService {
  ...
  getCitiesFrom(state) {
    return this.request
      .get(`http://educacao.dadosabertosbr.com/api/cidades/${state.toLowerCase()}`)
      .then(response => response.data);
  }
}

CidadeEstadoService.$inject = ['$http'];

module.exports = CidadeEstadoService;
